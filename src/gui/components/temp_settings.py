            ...
            controls=[
                ...
                ft.Container(
                    content=ft.Column(horizontal_alignment=ft.CrossAxisAlignment.STRETCH, controls=[
                        ...
                        ft.ExpansionTile(
                            title=ft.Text("1. Tài khoản UTH", size=14, weight=ft.FontWeight.BOLD, color=C.TEXT_PRIMARY),
                            subtitle=ft.Text("Thông tin đăng nhập hệ thống elearning", size=12, color=C.TEXT_SECONDARY),
                            controls=[
                        ...
                        ft.ExpansionTile(
                            title=ft.Text("2. Hiển thị & Giao diện", size=14, weight=ft.FontWeight.BOLD, color=C.TEXT_PRIMARY),
                            subtitle=ft.Text("Thiết lập cách hiển thị trên màn hình", size=12, color=C.TEXT_SECONDARY),
                            controls=[
                                ft.Container(content=ft.Column([
                                    self._sw_submitted,
                                    self._sw_graded,
                                    self._sw_always_on_top,
                                ]), padding=10)
                            ],
                            collapsed_text_color=C.TEXT_PRIMARY,
                            text_color=C.ACCENT,
                        ...
                        ft.ExpansionTile(
                            title=ft.Text("3. Hệ thống & Khởi động", size=14, weight=ft.FontWeight.BOLD, color=C.TEXT_PRIMARY),
                            subtitle=ft.Text("Thiết lập tự khởi động và thu nhỏ", size=12, color=C.TEXT_SECONDARY),
                            controls=[
                                ft.Container(content=ft.Column([
                        ...
                        ft.ExpansionTile(
                            title=ft.Text("4. Cảnh báo & Thời gian", size=14, weight=ft.FontWeight.BOLD, color=C.TEXT_PRIMARY),
                            subtitle=ft.Text("Ngưỡng thời gian màu sắc tuỳ chỉnh", size=12, color=C.TEXT_SECONDARY),
                            controls=[
                                ft.Container(content=ft.Column([
                        ...
                        ft.ExpansionTile(
                            title=ft.Text("5. Tự động & Thông báo", size=14, weight=ft.FontWeight.BOLD, color=C.TEXT_PRIMARY),
                            subtitle=ft.Text("Thời gian làm mới và chuông báo", size=12, color=C.TEXT_SECONDARY),
                            controls=[
                                ft.Container(content=ft.Column([
                        ...
                        ft.ExpansionTile(
                            title=ft.Text("6. Tích hợp Bot", size=14, weight=ft.FontWeight.BOLD, color=C.TEXT_PRIMARY),
                            subtitle=ft.Text("Telegram, Discord", size=12, color=C.TEXT_SECONDARY),
                            controls=[
                                ft.Container(content=ft.Column([
                                    self._sw_discord,
                                    self._sw_telegram,
                        ...
                        ft.ExpansionTile(
                            title=ft.Text("7. Nâng cao & Gỡ lỗi", size=14, weight=ft.FontWeight.BOLD, color=C.TEXT_PRIMARY),
                            subtitle=ft.Text("Luồng tải, Log hệ thống", size=12, color=C.TEXT_SECONDARY),
                            controls=[
                                ft.Container(content=ft.Column([
                                    self._workers_field,
