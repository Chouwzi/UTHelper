...
|---|---|---|---|
| `username` | string | ✅ | Student ID (e.g., `080206011901`) |
| `password` | string | ✅ | URL-encoded password (e.g., `NoBoi%2386226624`) |
...
```json
{
  "token": "89a2fce0533f89ee5238071c97903705",
  "privatetoken": "Zl1mUGgQx8ik0yNDm3xZKOXapqzXymEDAbToCFQmZTZjDvqDxm9HuIMkzhLHiJ7Q"
}
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_webservice_get_site_info&moodlewsrestformat=json
```
...
{
  "sitename": "Elearning",
  "username": "080206011901",
  "firstname": "Nguyễn Trần Đình",
  "lastname": "Chương",
  "fullname": "Nguyễn Trần Đình Chương",
  "lang": "vi",
  "userid": 11763,
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_user_get_users_by_field&field=id&values[0]=11763&moodlewsrestformat=json
```
...
[
  {
    ...
    "firstname": "Nguyễn Trần Đình",
    "lastname": "Chương",
    "email": "nguyentrandinhchuongd4.c3hn2023@gmail.com",
    "department": "",
    "institution": "",
    "idnumber": "100625",
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_enrol_get_users_courses&userid=11763&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=gradereport_overview_get_course_grades&userid=11763&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=gradereport_user_get_grade_items&courseid=21129&userid=11763&moodlewsrestformat=json
```
  ...
  "usergrades": [
    {
      ...
      "userid": 11763,
      "userfullname": "Nguyễn Trần Đình Chương",
      "useridnumber": "100625",
      "maxdepth": 1,
      "gradeitems": [
        {
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=mod_assign_get_assignments&courseids[0]=21252&courseids[1]=21263&courseids[2]=21129&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=mod_assign_get_submission_status&assignid=112407&userid=11763&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=mod_quiz_get_quizzes_by_courses&courseids[0]=21129&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=mod_quiz_get_user_attempts&quizid=71353&userid=11763&status=finished&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=mod_quiz_get_user_best_grade&quizid=71353&userid=11763&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_calendar_get_calendar_upcoming_view&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_calendar_get_action_events_by_timesort&timesortfrom={UNIX_NOW}&timesortto={UNIX_NOW+48h}&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_course_get_updates_since&courseid=21252&since=1781900000&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_course_get_contents&courseid=21252&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=core_completion_get_activities_completion_status&courseid=21129&userid=11763&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=message_popup_get_popup_notifications&useridto=11763&limit=5&moodlewsrestformat=json
```
...
```
GET https://courses.ut.edu.vn/webservice/rest/server.php?wstoken=89a2fce0533f89ee5238071c97903705&wsfunction=message_popup_get_unread_popup_notification_count&useridto=11763&moodlewsrestformat=json
```
